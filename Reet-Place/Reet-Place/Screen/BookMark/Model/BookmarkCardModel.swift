...
extension BookmarkCardModel {
    ...
    static func allMock(_ completion: @escaping((Array<BookmarkCardModel>) -> Void)) {
        completion([
            ...
            BookmarkCardModel(placeName: "스탠스커피", categoryName: "카페", starCount: 3, address: "서울 마포구 와우산로11길 9 1층", groupType: "다녀왔어요", infoCount: 0, withPeople: "훈성 재욱", relatedUrl: ["http://instagram.com/stancecoffee"]),
