//
//  CategoryDetailPhotoBoothView.swift
//  Reet-Place
//
...
class CategoryDetailPhotoBoothView: CategoryDetailView {
    ...
    override func bindCategoryDetailList(viewModel: CategoryFilterBottomSheetVM, bag: DisposeBag) {
        let dataSource = RxCollectionViewSectionedReloadDataSource<CategoryDetailPhotoBoothDataSource> { _,
            collectionView,
            indexPath,
            categoryType in
        ...
        viewModel.output.categoryDetailPhotoBoothDataSource
