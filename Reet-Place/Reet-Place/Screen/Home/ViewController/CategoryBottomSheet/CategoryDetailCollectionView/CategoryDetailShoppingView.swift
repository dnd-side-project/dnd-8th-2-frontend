//
//  CategoryDetailShoppingView.swift
//  Reet-Place
//
...
class CategoryDetailShoppingView: CategoryDetailView {
    ...
    override func bindCategoryDetailList(viewModel: CategoryFilterBottomSheetVM, bag: DisposeBag) {
        let dataSource = RxCollectionViewSectionedReloadDataSource<CategoryDetailShoppingDataSource> { _,
            collectionView,
            indexPath,
            categoryType in
        ...
        viewModel.output.categoryDetailShoppingDataSource
